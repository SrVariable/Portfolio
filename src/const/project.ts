export const PROJECTS = [
    {
        ...
        description: 'Metric exporter for MongoDB. It collects metrics from a database and exposes them in a format that can be scraped by Prometheus and displayed in Grafana. Developed in Go as part of my internship in iAR Soft.',
        technologies: [
            'Go',
            'Docker',
            'Prometheus',
